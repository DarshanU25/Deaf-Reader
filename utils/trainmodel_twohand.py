# ==== Two-Hand Gesture Model (84 keypoints) ====
import numpy as np
...
NUM_KEYPOINTS = 84
NUM_CLASSES = 30
dataset_path = 'model/keypoint_classifier/keypoint_twohand.csv'
model_save_path = 'model/keypoint_classifier/keypoint_classifier_twohand.hdf5'
tflite_save_path = 'model/keypoint_classifier/keypoint_classifier_twohand.tflite'
